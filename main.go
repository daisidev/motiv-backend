...
func main() {
	...
	app.Use(cors.New(cors.Config{
		AllowOrigins:     "http://localhost:3000, http://localhost:3001, https://motiv-six.vercel.app, http://127.0.0.1:3000, https://motiv-azure.vercel.app, https://motiv-alpha-seven.vercel.app",
